...
static void parse_commandline(int argc, char *argv[]) {
    ...
    if (!vm["threads"].defaulted()) {
		...
		// I added this NEXT ONE LINE and commented everything else below:
		// THEN I reversed it (aka I undid my changes, cuz I'm not sure what threading is gonna do to hurt things)
